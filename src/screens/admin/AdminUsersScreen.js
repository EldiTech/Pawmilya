...
const AdminUsersScreen = ({ onGoBack, adminToken }) => {
    ...
    try {
      ...
      if (Array.isArray(data)) {
        const formattedUsers = data.map(user => ({
          ...
          email: user.email,
          phone: user.phone || '',
          avatar: user.avatar_url || generateAvatarUrl(user.full_name),
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingUser) {
        const response = await fetch(`${CONFIG.API_URL}/admin/users/${editingUser.id}`, {
          method: 'PUT',
          headers: {
            'Authorization': `Bearer ${adminToken}`,
            'Content-Type': 'application/json',
        ...
        const newUser = {
          ...
          avatar: generateAvatarUrl(data.user.full_name),
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              const response = await fetch(`${CONFIG.API_URL}/admin/users/${user.id}`, {
                method: 'DELETE',
                headers: {
                  'Authorization': `Bearer ${adminToken}`,
                  'Content-Type': 'application/json',
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
              const response = await fetch(`${CONFIG.API_URL}/admin/users/${user.id}/status`, {
                method: 'PUT',
                headers: {
                  'Authorization': `Bearer ${adminToken}`,
                  'Content-Type': 'application/json',
